...
**From:** Edwin
**Date:** 2026-07-14
**Purpose:** Your milestone-by-milestone build brief for the ConEd Steam Attrition redesign integration. This file is the shim between the design system (`system-v1.1.md`), the roadmap (`docs/ref/2026-07-16_fable-roadmap.md` + `roadmap-supplement-m0.md`), and the codebase (`CLAUDE.md`). If you find a conflict between this brief and any of those three, the canonical docs win — flag it in Slack and I'll fix this brief.
...
### Acceptance criteria (from `docs/ref/2026-07-16_fable-roadmap.md` M3, verbatim)
...
Acceptance criteria met (docs/ref/2026-07-16_fable-roadmap.md M3):
...
### Acceptance criteria (from `docs/ref/2026-07-16_fable-roadmap.md` M4, verbatim)
...
### Acceptance criteria (from `docs/ref/2026-07-16_fable-roadmap.md` M8, verbatim)
...
### Acceptance criteria (from `docs/ref/2026-07-16_fable-roadmap.md` M9, verbatim)
...
### Empty state
The landing must read honestly without `events.json`. If M7 slips, render the designed placeholder per `docs/ref/2026-07-16_fable-roadmap.md` M7 graceful degradation.
...
### Acceptance criteria (from `docs/ref/2026-07-16_fable-roadmap.md` M11 + `system-v1.1.md` §5)
...
| M6 Postgres schema | `system-v1.1.md` §9 + `docs/ref/2026-07-13_ismael-q1-q10-response.md` Q7 |
